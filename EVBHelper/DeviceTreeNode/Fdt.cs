...
public class Fdt
{
    ...
    public IEnumerable<MemoryReservation> MemoryReservations
    {
        get
        {
            ...
            var stream = new FdtData([.. _data.Skip((int)_header.MemoryReservationOffset)]);
    ...
    public IEnumerable<string> Strings
    {
        get
        {
            ...
            int offset = 0;
            byte[] stringsBlock = [.. _data.Skip((int)_header.StringsOffset).Take((int)_header.StringsSize)];
    ...
    {
        return [.. _data.Skip((int)_header.StructOffset).Take((int)_header.StructSize)];
    }
