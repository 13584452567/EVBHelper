...
namespace DeviceTreeNode.Core
{
    ...
    public class FdtSerializer
    {
        ...
        {
            // 收集内存保留块
            _memoryReservations = [.. _fdt.MemoryReservations];
            ...
            // 创建输出流
            MemoryStream output = new(totalSize);
        ...
        private void SerializeRoot()
        {
            ...
            BinaryWriter structWriter = new(_structsStream);
            BinaryWriter stringWriter = new(_stringsStream);
