...
internal static class CommandLineParser
{
    ...
    private static string BuildHelpText()
    {
        ...
        sb.AppendLine();
    sb.AppendLine("Usage: OpenixCard <options> <输入文件或目录>");
        sb.AppendLine();
        sb.AppendLine("选项:");
        ...
        sb.AppendLine();
        sb.AppendLine("示例:");
    sb.AppendLine("  OpenixCard -u  firmware.img");
    sb.AppendLine("  OpenixCard -u -c firmware.img");
    sb.AppendLine("  OpenixCard -d  firmware.img");
    sb.AppendLine("  OpenixCard -p  unpacked_dir");
    sb.AppendLine("  OpenixCard -s  firmware.img");
        return sb.ToString();
    }
