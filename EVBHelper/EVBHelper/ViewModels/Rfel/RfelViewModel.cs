...
namespace EVBHelper.ViewModels.Rfel;

public partial class RfelViewModel : ViewModelBase
{
    ...
    public RfelViewModel(IRfelCliService rfelCliService, IFileDialogService fileDialogService)
    {
